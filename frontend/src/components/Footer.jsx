      ...
      <div className="footer__container">
        <div className="footer__grid">
          ...
          <div className="footer__column">
            ...
            <ul className="footer__list">
              <li className="footer__list-item">
                <span className="footer__list-link"><SiScikitlearn /> ExtraTrees Sampling</span>
              </li>
              <li className="footer__list-item">
          ...
          <div className="footer__column">
            ...
            <ul className="footer__list">
              ...
              <li className="footer__list-item">
                <a href="#faq" className="footer__list-link">FAQ</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer__bottom">
          <div className="footer__made-with">
            ...
            >
              <span className="footer__author-first">Renish</span>{' '}
              <span className="footer__author-last">Kankrecha</span>
            </a>
          </div>
